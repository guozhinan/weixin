<template>
    <section class="wrapper">
        ...
        <div class="mindList" v-show="mindList.length>0">
          <router-link :to="{name:'myTaskMind',params:{id:item.tTask.id}}" class="mindItem" :key="index" v-for="(item,index) in mindList">
...
<script>
    import {getReceiveList,getOpenid,checkLogin} from 'src/service/getData'
      ...
      data(){
        ...
        methods: {
          ...
          getReceiveList() {
            ...
            getReceiveList({openid}).then(res => {
